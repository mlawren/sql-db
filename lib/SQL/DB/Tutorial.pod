...
in the same query. Show me the Artist names and their Album titles
...
For interest's sake, here is the actual SQL:
...
way around. I.e., there is no $cd->tracks method. I'm still having a
