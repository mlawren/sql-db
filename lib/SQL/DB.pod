...
their databases to work just as hard as their Perl scripts. For very
basic needs the L<SQL::DBx::Simple> extension may be a more appropriate
starting point.
...
L<SQL::DBx::Sequence>, L<SQL::DBx::Deploy>
