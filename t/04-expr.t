...
#    [$e1 == ($e1 .OR. ($e2 .AND. ($e1 == $e2))), 'e1 = e1 OR (e2 AND e1 = e2)'],
    ...
    [
        ...
        'e1 BETWEEN bv{x}::(none) AND 34 AND ((e1 AND e2) AND (e1 OR e2))'
    ],
